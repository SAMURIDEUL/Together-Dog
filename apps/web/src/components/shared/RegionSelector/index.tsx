...
export const RegionSelector = ({
  ...
  const dongs =
    selectedSido && selectedSigungu
      ? REGION_DATA[selectedSido][selectedSigungu]
      : [];
  ...
  return (
    <div className='fixed inset-0 z-[70] flex items-center justify-center bg-black/50 p-4 backdrop-blur-sm'>
      <div className='relative w-full max-w-2xl overflow-hidden rounded-2xl bg-white shadow-2xl transition-all'>
        ...
        {/* 선택 영역 */}
        <div className='grid h-[400px] grid-cols-3 divide-x'>
          {/* 1. 시/도 */}
          ...
          {/* 2. 시/군/구 */}
          <div className='scrollbar-thin overflow-y-auto bg-gray-50/50 p-2'>
            <div className='mb-2 px-3 text-xs font-semibold uppercase text-gray-400'>
              시/군/구
            </div>
