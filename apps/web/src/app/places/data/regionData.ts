/**
 * 행정구역 데이터 (시/도 -> 시/군/구 -> 읍/면/동)
 * 데이터 크기를 고려하여 주요 지역 위주로 구성하거나, 
 * 실제 프로덕션에서는 API로 가져오는 것이 좋으나 현재는 상수로 관리합니다.
 */
...
export const REGION_DATA: RegionData = {
  '서울': {
    ...
    '동작구': ['노량진동', '대방동', '동작동', '본동', '사당동', '상도동', '수산동', '신대방동', '흑석동'],
    '마포구': ['공덕동', '구수동', '당인동', '대흥동', '도화동', '마포동', '망원동', '상암동', '상수동', '서교동', '성산동', '신공덕동', '신수동', '신정동', '아현동', '연남동', '염리동', '용강동', '중동', '창전동', '토정동', '하중동', '합정동'],
    ...
    '양천구': ['목동', '신월동', '신정동'],
    '영등포구': ['당산동', '대림동', '도림동', '문래동', '신길동', '양평동', '양화동', '여의도동', '영등포동', '영등포본동'],
    ...
    '종로구': ['가회동', '견지동', '경운동', '계동', '공평동', '관수동', '관철동', '관훈동', '교남동', '교북동', '구기동', '권농동', '낙원동', '내수동', '내자동', '누상동', '누하동', '당주동', '도렴동', '돈의동', '동숭동', '명륜동', '묘동', '무악동', '봉익동', '부암동', '사간동', '사직동', '삼청동', '서린동', '세종로', '소격동', '송월동', '송현동', '수송동', '숭인동', '신교동', '신문로', '신영동', '안국동', '연건동', '연지동', '예지동', '옥인동', '와룡동', '운니동', '원남동', '원서동', '이화동', '익선동', '인사동', '인의동', '장사동', '재동', '적선동', '종로', '중학동', '창성동', '창신동', '청운동', '청재동', '체부동', '충신동', '통의동', '통인동', '팔판동', '평동', '평창동', '필운동', '행촌동', '혜화동', '홍지동', '홍파동', '화동', '효자동', '효제동', '훈정동'],
    '중구': ['광희동', '남학동', '남대문로', '다산동', '무학동', '방산동', '봉래동', '북창동', '산림동', '삼각동', '서소문동', '소공동', '수표동', '수하동', '순화동', '신당동', '쌍림동', '예관동', '예장동', '오장동', '을지로', '의주로', '인현동', '입정동', '장교동', '장충동', '저동', '정동', '주교동', '주자동', '중림동', '초동', '충무로', '충정로', '태평로', '필동', '황학동', '회현동', '흥인동'],
